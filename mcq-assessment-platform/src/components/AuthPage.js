    ...
    <div className={styles.hero}>
      <div className={styles.formbox}>
        <div className={styles.buttonBox}>
          ...
          <button type="button" className={styles.toggleBtn} onClick={() => setIsLoginForm(true)}>Log In</button>
          <button type="button" className={styles.toggleBtn} onClick={() => setIsLoginForm(false)}>Register</button>
        </div>
        ...
        <form className={`${styles.inputGroup} ${styles.login}`} style={{left: isLoginForm ? '50px' : '-400px'}}>
